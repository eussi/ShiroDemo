 ...
 */
public class _07_SimplePermissionTest extends BaseTest {

    @Test
    public void testIsPermitted_123_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm", "12345");
        //判断拥有权限：user:create
    ...
    public void testWildcardPermission_4_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm1", "12345");
...
//        subject().checkPermissions("system:user:update,delete");
    ...
    public void testWildcardPermission_4_2() {
        login("classpath:_07_shiro-permission.ini", "wangxm2", "12345");
    ...
    public void testWildcardPermission_5_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm3", "12345");
...
//        subject().checkPermissions("system:user");
    ...
    public void testWildcardPermission_5_2() {
        login("classpath:_07_shiro-permission.ini", "wangxm4", "12345");
    ...
    public void testWildcardPermission_6_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm5", "12345");
...
//        subject().checkPermissions("system:user:view");
    ...
    public void testWildcardPermission_6_2() {
        login("classpath:_07_shiro-permission.ini", "wangxm6", "12345");
...
//        subject().checkPermissions("user:view");
    ...
    public void testWildcardPermission_7_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm7", "12345");
        subject().checkPermissions("user:view:1");
    }

    @Test
    public void testWildcardPermission_7_2() {
        login("classpath:_07_shiro-permission.ini", "wangxm8", "12345");
    ...
    public void testWildcardPermission_7_3() {
        login("classpath:_07_shiro-permission.ini", "wangxm9", "12345");
    ...
    public void testWildcardPermission_7_4() {
        login("classpath:_07_shiro-permission.ini", "wangxm10", "12345");
    ...
    public void testWildcardPermission_7_5() {
        login("classpath:_07_shiro-permission.ini", "wangxm11", "12345");
    ...
    public void testWildcardPermission_8_1() {
        login("classpath:_07_shiro-permission.ini", "wangxm12", "12345");
