...
insert into users(username, password, password_salt) values('wangxm', '12345', null);
insert into user_roles(username, role_name) values('wangxm', 'role1');
insert into user_roles(username, role_name) values('wangxm', 'role2');
